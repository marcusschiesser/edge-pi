...
- Internal: `Fixed foo ([#123](https://github.com/marcusschiesser/edge-pi/issues/123))`
- External: `Added bar ([#456](https://github.com/marcusschiesser/edge-pi/pull/456) by [@user](https://github.com/user))`
