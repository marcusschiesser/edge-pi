...
import type { Api, KnownProvider, ModelInfo } from "../src/core/ai-types.js";

// Use ModelInfo as the Model type in this script
type Model<T extends Api = Api> = ModelInfo<T>;
...
type Model<T extends string> = ModelInfo<T>;
...
`;
	...
	// Write file
	writeFileSync(join(packageRoot, "src/core/models.generated.ts"), output);
	console.log("Generated src/core/models.generated.ts");
